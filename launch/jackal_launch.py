...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'vf_initialization_method', default_value='file',  # sdf, cbf, or file
            description='Value function initialization method'),
        DeclareLaunchArgument(
            'backend', default_value='hardware',  #hardware or sim
            description='sim or hardware backend for jackal'),
        DeclareLaunchArgument(
            'vf_update_method', default_value='file',  # file or pubsub
